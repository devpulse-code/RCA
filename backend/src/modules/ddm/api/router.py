...
from backend.src.modules.ddm.api.admin import router as admin_root_router   # <-- NEW

router.include_router(admin_root_router, prefix="/admin")                    # <-- NEW
